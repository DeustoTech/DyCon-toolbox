...
t2 = 9.96;
t1 = 2;
U0_tline = [1*(tline<=(T_f/T_f)).*(tline>=(t1/T_f));T_f*ones(size(tline))]'; 
uf = [-1;1];
...
t2 = 9.96;
t1 = 2;
U0_tline = [1*(tline<=(t2/T_f)).*(tline>=(t1/T_f));T_f*ones(size(tline))]'; 
uf = [-1;1];
...
t2 = 5.1727;
t1 = 0;
U0_tline = [1.5662*(tline<=(t2/T_f)).*(tline>=(t1/T_f));T_f*ones(size(tline))]'; 
uf = [-1;1];
...
%%
%U0_tline = interp1(tline1,temp1,tline);
%GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{},'tol',1e-3,'Graphs',true,'U0',U0_tline);
GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{},'tol',1e-5,'Graphs',true,'U0',temp);
...
%% Figure : Cost with time minimization
% $$ J = 1*|ue(T)-uf|^2 + 0.001*\int_0^T |u(t)|^2dt. $$
...
%GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{'StopCriteria','Jdiff'},'tol',1e-4,'Graphs',true,'U0',U0_tline);
GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{},'tol',1e-4,'Graphs',true,'U0',U0_tline);
%GradientMethod(iP,'DescentAlgorithm',@AdaptativeDescent,'DescentParameters',{'StopCriteria','Jdiff'},'tol',1e-4,'Graphs',true,'U0',U0_tline);
...
%U0_tline = interp1(tline1,temp1,tline);
%GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{},'tol',1e-3,'Graphs',true,'U0',U0_tline);
GradientMethod(iP,'DescentAlgorithm',@ConjugateGradientDescent,'DescentParameters',{},'tol',1e-4,'Graphs',true,'U0',temp);
