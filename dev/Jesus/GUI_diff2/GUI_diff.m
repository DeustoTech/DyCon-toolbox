...
set(h.figure,'DefaultuipanelFontSize',12)
set(h.figure,'DefaultuicontrolFontSize',12)
...
ui_main = uicontrol('Parent',mainpanel,'style','text','string',main_str,'unit','norm','pos',[0.1 0.15 0.8 0.4],'FontSize',20);
%% 
wd = 1.0;
ht = 0.2;
...
uicontrol('style','text','string',text,'Parent',IPEv_text,'unit','norm','pos',[0.1 0.05 0.8 0.7],'Fontsize',15)

text = 'Location of the pollution sources and their intensities';
uicontrol('style','text','string',text,'Parent',IPEs_text,'unit','norm','pos',[0.1 0.05 0.8 0.6],'Fontsize',15)
...
%%
%%
btn_dyn    = uicontrol('Parent',IPEv_control,'String','Random Distribution','Unit','norm','Position',[0.35 0.3 0.3 0.4],'Callback',{@btn_solve_dyn_callback,h});
