...
%First
[a1CB1,b1CB1,c1CB1,OC1B1]=SLSD1doptimalnullcontrol(N,1/(N^2),G1,2,beta,[0.33,0.66],y1);
[a1CB2,b1CB2,c1CB2,OC1B2]=SLSD1doptimalnullcontrol(N,1/(N^2),@(x)G1(x)/(N^2),2,beta,[0.33,0.66],y1);
save([location,'DomenecSimulations_2.mat']);
%Second
[a2CB1,b2CB1,c2CB1,O2CB1]=SLSD1doptimalnullcontrol(N,1/(N^2),G2,2,beta,[0.33,0.66],y2);
[a2CB2,b2CB2,c2CB2,O2CB2]=SLSD1doptimalnullcontrol(N,1/(N^2),@(x)G2(x)/(N^2),2,beta,[0.33,0.66],y2);
%Third
