...
%%
  function LinealAdjoint(obj)
    ...
    iode.Y.sym = symY;
    %
    obj.adjoint.F.num = @(t,P,Y,U) (-obj.ode.A.'*P')';
    ...
    % P0(t,  y1,...,yn)
    obj.adjoint.PT.sym  = symfun(PT,[t symY.']);
    % Pasamos esta funcion a una function_handle

    obj.adjoint.PT.num = matlabFunction(obj.adjoint.PT.sym,'Vars',{t,symY});
  end
  ...
  function NonLinealAdjoint(obj)
    ...
    obj.adjoint.F.sym = symfun(dP_dt,[t symP symY.' symU.']);
    % Pasamos esta funcion a una function_handle
    obj.adjoint.F.num = matlabFunction(dP_dt,'Vars',{t,symP,symY,symU});
    ...
    obj.adjoint.PT.sym  = symfun(PT,[t symY.']);
    % Pasamos esta funcion a una function_handle
    obj.adjoint.PT.num = matlabFunction(PT,'Vars',{t,symY});
