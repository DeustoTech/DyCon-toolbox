classdef Pontryagin < handle & matlab.mixin.SetGet & matlab.mixin.Copyable
...
% visible: true
    ...
    methods
        ...
        %       dimension: [1x1]
            ...
            obj.J.symPsi  = symfun(symPsi,[t,symY.']);
            obj.J.numPsi  = matlabFunction(symPsi,'Vars',{t,symY});

            obj.J.symL    = symfun(symL,[t,symY.',symU.']);
            obj.J.numL    = matlabFunction(symL,'Vars',{t,symY,symU});
            %% Dynamics Definition                   
            obj.ode          = copy(iode);
