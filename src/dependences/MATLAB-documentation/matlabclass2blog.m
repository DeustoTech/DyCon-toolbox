function matlabclass2blog(ClassName)
    
FolderDocumentation ='/home/djoroya/Documentos/GitHub/CCM/Webs/dycon-toolbox-documentation/posts/07-API-docs/classes/';
...
%             
           ...
           %fprintf(outfile_constructor,'\n');
           %fprintf(outfile_constructor,['parent: ',ClassName,'\n']);
           %fprintf(outfile_constructor,['grand_parent: classes\n']);

           %fprintf(outfile_constructor,'layout: default\n');
           %fprintf(outfile_constructor,'---\n');
    ...
    %fprintf(outfile_constructor,['has_children: true\n']);
    fprintf(outfile_constructor,['grand_parent: API docs\n']);

    fprintf(outfile_constructor,['parent: classes\n']);
