%% title: Average Control by Conjugate Gradiente
%% date: 2018-07-21
...
%% 
% Cra
AverageProblem = AverageControl(A,B,x0,u0,span);
[ u addata ]= solveClassicalGradient(AverageProblem,[1 5 0]')
% 
% animation_sol(addata.xhistory,addata.uhistory,'dt',0.1,'ULim',[-10 20],'XLim',[-2 2])
%%
