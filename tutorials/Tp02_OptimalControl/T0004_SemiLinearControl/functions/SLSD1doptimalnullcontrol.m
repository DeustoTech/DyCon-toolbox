...
GradientParameters = {'tol',tol,'DescentParameters',DescentParameters,'graphs',false,'TypeGraphs','PDE','maxiter',maxiter};
%
...
targnormscb=targnormscb+iCP2.ode.Y(end,j)^2;
end
targnormscb/N;
end
