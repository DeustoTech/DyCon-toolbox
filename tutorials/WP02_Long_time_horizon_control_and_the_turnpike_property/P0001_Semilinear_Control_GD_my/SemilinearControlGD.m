...
%%
% $$
% \min_{u\in L^2((0,T)\times (0,\frac12))}J_{T}(u)=\frac12 \int_0^T\int_{0}^{0.5} |u(t)|^2 dxdt+\frac{\beta}{2}\int_0^T\int_{0}^{1} |y(t,x)-z(x)|^2 dxdt,
% $$
%%
% where:
%%
...
% $$
%% 
% The fucntional J_T is made of two addenda. The first one penalizes the
