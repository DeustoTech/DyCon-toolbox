...
% by a parameter dollars\betadollars that will be small.
YT = 0.2 + 0*xline';
dx = xline(2) - xline(1);
...
% dollars-dollars \partial_y[-5\exp(-y^2)] dollars-dollars
%%
syms x;
syms G(x);
syms U(x);
...
% diffusivity dollarsD=\frac{1}{N^3}dollars.
%%
...
% non-homogeneous non-linearity, we will just divide the non-linearity dollarsGdollars
% by dollarsN^3dollars
%%
